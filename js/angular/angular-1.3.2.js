...
function jqLiteData(element, key, value) {
	if (jqLiteAcceptsData(element)) {
		...
		if (isSimpleSetter) { // data('key', value)
			...
			extend(data, key);// mass-setter: data({key1: val1, key2: val2})
		}
	}
}
...
function jqLiteAddNodes(root, elements) {// THIS CODE IS VERY HOT. Don't make changes without benchmarking.
	if (elements) {
		if (elements.nodeType) {// if a Node (the most common case)
	...
	this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement', function($rootScope, $browser, $sniffer, $rootElement) {
		...
		$rootScope.$watch(function $locationWatch() {
			var oldUrl = $browser.url(),
				...
				urlOrStateChanged = oldUrl !== $location.absUrl() || ($location.$$html5 && $sniffer.history && oldState !== $location.$$state);
...
function ensureSafeObject(obj, fullExpression) {
	...
	if (obj) {
		...
		if (obj.window === obj) {// isWindow(obj)
...
Parser.prototype = {
	...
	fieldAccess: function(object) {
		var expression = this.text,
			...
			getter = getterFn(field, this.options, expression);
			...
			$emit: function(name, args) {
				...
				do {
					...
					for (i = 0, length=namedListeners.length; i < length; i++) {
						...
						try {//allow all listeners attached to the current scope to run
	...
	this.$get = ['$parse', '$sceDelegate', function($parse, $sceDelegate) {
		...
		if (enabled && msie < 8) {
			throw $sceMinErr('iequirks', [
				'Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.',
		...
		* @example
		...
		<file name="index.html">
			...
			<form name="myForm" ng-controller="DateController as dateCtrl">
				...
				<input type="datetime-local" id="exampleInput" name="input" ng-model="value" placeholder="yyyy-MM-ddTHH:mm:ss" min="2001-01-01T00:00:00" max="2013-12-31T00:00:00" required />
				<span class="error" ng-show="myForm.input.$error.required">Required!</span>
				<span class="error" ng-show="myForm.input.$error.datetimelocal">Not a valid date!</span>
 ...
 * This example shows how to apply the `ngCsp` directive to the `html` tag.
	...
	* @example
			...
			<example name="example.csp" module="cspExample" ng-csp="true">
				...
				<file name="script.js">
					 angular.module('cspExample', []).controller('MainController', function() {
						this.counter = 0;
						this.inc = function() {
							this.counter++;
						};
	...
	<example module="includeExample" deps="angular-animate.js" animations="true">
		...
		<file name="script.js">
			angular.module('includeExample', ['ngAnimate']).controller('ExampleController', ['$scope', function($scope) {
				$scope.templates = [ { name: 'template1.html', url: 'template1.html'}, { name: 'template2.html', url: 'template2.html'} ];
		...
		<example module="pluralizeExample">
			<file name="index.html">
				...
				<div ng-controller="ExampleController">
					...
					<!--- Example with offset --->
					With Offset(2):
					<ng-pluralize count="personCount" offset=2 when="{'0': 'Nobody is viewing.', '1': '{{person1}} is viewing.', '2': '{{person1}} and {{person2}} are viewing.', 'one': '{{person1}}, {{person2}} and one other person are viewing.', 'other': '{{person1}}, {{person2}} and {} other people are viewing.'}">
					</ng-pluralize>
				</div>
			</file>
			<file name="protractor.js" type="protractor">
...
if (window.angular.bootstrap) {// AngularJS is already loaded, so we can return here...
...
!window.angular.$$csp() && window.angular.element(document).find('head').prepend(['<style type="text/css">',
	'@charset "UTF-8";',
	'[ng\\:cloak],',
	'[ng-cloak],',
	'[data-ng-cloak],',
