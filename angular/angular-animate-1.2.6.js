		...
		*/
		function performAnimation(animationEvent, className, element, parentElement, afterElement, domOperation, doneCallback) {
			...
			var matches = lookup(animationLookup),
				isClassBased = animationEvent == 'addClass' || animationEvent == 'removeClass',
	...
	$animateProvider.register('', ['$window', '$sniffer', '$timeout', function($window, $sniffer, $timeout) {
		...
		function afterReflow(element, callback) {
			...
			animationTimer = $timeout(function() {
				...
				var elementQueueSnapshot = [],
					animationCounterSnapshot = animationCounter;
		...
		function animateRun(element, className, activeAnimationComplete) {
			...
			var timings = elementData.timings,
				...
				maxDuration = elementData.maxDuration,
				activeClassName = elementData.activeClassName,
				maxDelayTime = Math.max(timings.transitionDelay, timings.animationDelay) * ONE_SECOND,
				startTime = Date.now(),
