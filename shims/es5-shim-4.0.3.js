...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {// AMD. Register as an anonymous module.
		define(factory);
	} else if (typeof exports === 'object') {// Node. Does not work with strict CommonJS, but only CommonJS-like enviroments that support module.exports, like Node.
...
// Define configurable, writable and non-enumerable props if they don't exist.
var defineProperty;
...
defineProperties(ArrayPrototype, {// Safari 5.0 bug where .splice() returns undefined
...
var supportsExtendedYears = Date.parse('+033658-09-27T01:46:40.000Z') === 1e15,
	acceptsInvalidDates = !isNaN(Date.parse('2012-04-04T24:00:00.500Z')) || !isNaN(Date.parse('2012-11-31T23:59:59.000Z')),
		...
		function Date(Y, M, D, h, m, s, ms) {
			...
			if (this instanceof NativeDate) {
				var date = length === 1 && String(Y) === Y ? // isString(Y)
						...
						length >= 1 ? new NativeDate(Y) : new NativeDate();
